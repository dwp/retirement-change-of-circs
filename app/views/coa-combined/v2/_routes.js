...
router.post('/coa-combined/v1/how-we-contact-you/contact-check-your-details', function (req, res) {
...
router.post('/coa-combined/v1/how-we-contact-you/provide-email-address', function (req, res) {
  res.redirect('/coa-combined/v1/how-we-contact-you/provide-phone-number.html')


});

// ROUTING FROM SELECT INVESTMENTS TO MONEY YOU HAVE TODAY
router.post('/coa-combined/v1/how-we-contact-you/provide-phone-number', function (req, res) {
  res.redirect('/coa-combined/v1/how-we-contact-you/contact-check-your-details.html.html')
